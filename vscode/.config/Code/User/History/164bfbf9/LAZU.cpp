...
int main(int argc, char** argv) {
    ...
    // Example: ISS (ZARYA) — replace with your mission TLE
    const char* TLE1 = "1 25544U 98067A   20344.91667824  .00001264  00000-0  29621-4 0  9991";
    ...
    float startracker_fov_deg = 20.0f; // full cone angle
    float payload_boresight[3] = {0.0f, 0.0f, 1.0f};
    float payload_fov_deg = 10.0f; // full cone angle
